...
function initSliders() {
  if (document.querySelector(".services__slider")) {
    new Swiper(".services__slider", {
      ...
      */
      // Скроллбар
      scrollbar: {
        el: ".services__wrapper-scrollbar",
        draggable: true
      },
      // Кнопки "вліво/вправо"
      navigation: {
  ...
  if (document.querySelector(".transformations__slider")) {
    new Swiper(".transformations__slider", {
      // <- Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
      modules: [Navigation],
      ...
      */
      ...
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".transformations__pagination-swiper-button-prev",
        nextEl: ".transformations__pagination-swiper-button-next"
      },
      // Брейкпоінти
      breakpoints: {
        320: {
...
document.addEventListener("DOMContentLoaded", function() {
  const form = document.querySelector(".top-hero__form");
  const formBody = document.querySelector(".top-hero__form_body");
  const input = document.querySelector(".top-hero__form_input");
  const button = document.querySelector(".top-hero__form_button");
  ...
  document.addEventListener("click", function(e) {
    if (isSearchOpen && !form.contains(e.target)) {
      closeSearch();
    }
  });
});
